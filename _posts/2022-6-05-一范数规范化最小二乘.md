...
$$
L_c(\lbracex_i\rbrace,z,\lbrace\lambda_i\rbrace)=\sum_{i-1}^{20}f_i(x_i)+g(z)+\sum_{i=1}^{20} \lambda_i(x_i-z)+\frac{c}{2}\sum_{i=1}^{20}\|x_i-z\|^2
$$
...
z^{k+1} &= \arg\min_{z} L_c(\lbracex_i^{k+1}\rbrace,z,\lbrace\lambda_i^k\rbrace) \\
